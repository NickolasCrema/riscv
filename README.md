# Trabalho da disciplina de Organização e Arquitetura de Computadores
...
---
  ...
  <h3>Entrada</h3>
  <img src='https://github.com/NickolasCrema/imagens_readmes/blob/main/riscv/entrada.png?raw=true' width=300px/>
  <h3>Execução</h3>
